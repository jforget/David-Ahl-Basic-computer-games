...
110 REM
120 REM     Test script to check variables with long names
...
370 REM
1010 LET supercalifragilisticexpialidocious = 1
1020 LET supercalifragilisticexpialidociousness = 9
1030 PRINT supercalifragilisticexpialidocious
1040 PRINT supercalifragilisticexpialidociousness
